...
#     xl = abs(x2 - x1)
#     yl = abs(y2 - y1)
#     if l == xl**2 + yl**2: # 외접한다고 가정을 했을때 두 중심점 사이의 거리가 두 원의 반지름을 더한 값과 같으면 한점에서 만난다.
#         print(1)
#     elif l > xl**2 + yl**2: # 두 중심점 사이의 거리가 두 원의 반지름을 더한 값보다 크면 만나지 않는다.
#         print(0)
#     elif l < xl**2 + yl**2: # 두 중심점 사이의 거리가 두 원의 반지름을 더한 값보다 작으면 두점에서 만난다.
#         print(2)
